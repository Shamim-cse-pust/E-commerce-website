                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/storage/product') }}/{{ $product->product_image }}" alt="" class="img-fluid rounded h-20 w-20"></td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('product.edit', $product->slug) }}">
